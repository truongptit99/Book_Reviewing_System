...
(() => {
/*!****************************************!*\
  !*** ./resources/js/book_statistic.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
...
window.onload = function () {
  ...
  var labels = [translator.trans('messages.jan'), translator.trans('messages.feb'), translator.trans('messages.mar'), translator.trans('messages.apr'), translator.trans('messages.may'), translator.trans('messages.jun'), translator.trans('messages.jul'), translator.trans('messages.aug'), translator.trans('messages.sep'), translator.trans('messages.oct'), translator.trans('messages.nov'), translator.trans('messages.dec')];
